...
export const CERFA_MAPPINGS: Record<string, CaseMapping> = {
  ...
  stocks: {
    ...
    description: 'Matières premières, en-cours de production, produits finis, marchandises',
    categorie: 'actif',
    normal: {
      formulaire: '2050',
  ...
  dettes_financieres: {
    ...
    description: 'Total des emprunts et dettes financières (hors découverts bancaires)',
    categorie: 'passif',
    normal: {
      formulaire: '2051',
      cases: 'DR+DS+DT',
  ...
  dettes_fiscales_sociales: {
    ...
    description:
      'Dettes fiscales, dettes sociales (personnel, organismes sociaux). En liasse simplifiée : case 172 (autres dettes) moins case 169 (comptes courants associés)',
    categorie: 'passif',
    normal: {
      formulaire: '2051',
      cases: 'DY',
  ...
  comptes_courants_associes: {
    ...
    description:
      "Comptes courants créditeurs d'associés. En liasse simplifiée : case 169 (dont comptes courants dans autres dettes)",
    categorie: 'passif',
    normal: {
      formulaire: '2051',
      cases: 'DW',
  ...
  decouvert_bancaire: {
    ...
    description:
      'Concours bancaires courants et soldes créditeurs de banques. ATTENTION : Non isolable en liasse simplifiée (inclus dans emprunts case 156)',
    categorie: 'passif',
    normal: {
      formulaire: '2051',
      cases: 'EH',
  ...
  subventions_exploitation: {
    ...
    description:
      "Subventions d'exploitation reçues. En liasse simplifiée 2033-B : case 226 UNIQUEMENT. NE PAS CONFONDRE avec case 230 'Autres produits'",
    categorie: 'resultat',
    normal: {
      formulaire: '2052',
      cases: 'FO',
  ...
  reprises_provisions_exploitation: {
    ...
    description:
      'Reprises sur amortissements et provisions, transferts de charges. ATTENTION : Non isolable en liasse simplifiée 2033-B, mettre 0',
    categorie: 'resultat',
    normal: {
      formulaire: '2052',
      cases: 'FP',
  ...
  reprises_provisions: {
    ...
    description:
      'Reprises sur amortissements et provisions. ATTENTION : Non isolable en liasse simplifiée 2033-B, mettre 0',
    categorie: 'resultat',
    normal: {
      formulaire: '2052',
      cases: 'FP',
  ...
  impots_taxes: {
    ...
    description: 'Impôts et taxes (hors impôt sur les bénéfices) : taxe pro, taxe foncière, etc.',
    categorie: 'resultat',
    normal: {
      formulaire: '2052',
      cases: 'FX',
  ...
  dotations_amortissements: {
    ...
    description:
      "Dotations aux amortissements sur immobilisations + dotations aux provisions d'exploitation",
    categorie: 'resultat',
    normal: {
      formulaire: '2052',
      cases: 'GA+GB+GC',
  ...
  autres_produits_financiers: {
    ...
    description: 'Intérêts et produits assimilés, reprises de provisions financières',
    categorie: 'resultat',
    normal: {
      formulaire: '2053',
  ...
  charges_financieres: {
    ...
    description: "Intérêts et charges assimilées (intérêts d'emprunts, agios, etc.)",
    categorie: 'resultat',
    normal: {
      formulaire: '2053',
      cases: 'GU',
  ...
  valeur_ajoutee: {
    id: 'valeur_ajoutee',
    nom: 'Valeur ajoutée',
    description: 'Marge commerciale + Production - Consommations intermédiaires',
    categorie: 'sig',
    normal: {
      formulaire: '2052',
      cases: 'Calculé',
      formule: '(FC - FS - FT) + (FD + FE + FF + FM + FN) - (FU + FV + FW)',
    },
    simplified: {
      formulaire: '2033-B',
      cases: 'Calculé',
      formule: '(210 - 234 - 236) + (214 + 218 + 220 + 222) - (238 + 240 + 242)',
    },
    unite: 'euros',
    signe: 'mixte',
  },
  ...
  caf: {
    ...
    normal: {
      formulaire: '2053',
      cases: 'Calculé',
      formule: 'HN + GA + GB + GC + GR + GS + HG - FP - GM - GO - GP - HC + HF - HD',
    },
    simplified: {
      formulaire: '2033-B',
      cases: 'Calculé',
  ...
  bfr: {
    ...
    simplified: {
      formulaire: '2033-A',
      cases: 'Calculé',
      formule: '(050 à 080 + 092) - (164 + 166 + 168 + 170 + 172 + 174 + 176)',
    },
    unite: 'euros',
    signe: 'mixte',
  },
 ...
 */
export function getMappingsByCategorie(categorie: CaseMapping['categorie']): CaseMapping[] {
...
export function generateExtractionPrompt(
  ...
  lines.push(`Type de liasse : ${isSimplified ? 'Simplifiée (2033)' : 'Normale (2050-2059)'}`)
  lines.push('')
