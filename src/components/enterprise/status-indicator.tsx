...
const STATUS_CONFIG: Record<EnterpriseStatus, { label: string; className: string }> = {
  ...
  extrait: {
    label: "Extrait",
    className: "bg-orange-50 text-orange-600 hover:bg-orange-50 dark:bg-orange-950 dark:text-orange-300",
  },
  valide: {
    label: "Validé",
  ...
  analyse: {
    label: "Analysé",
    className: "bg-green-100 text-green-700 hover:bg-green-100 dark:bg-green-900 dark:text-green-200",
  },
};
