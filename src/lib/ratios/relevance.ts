...
export function isRatioRelevant(
  ...
  switch (ratioKey) {
    ...
    // Note: variation_marge_commerciale_n1 et variation_rotation_stocks_n1
    // sont gérés plus haut (vérification de seuil + disponibilité N-1)
    // -------------------------------------------------------------------------
    ...
    // Note: variation_marge_commerciale_n2 et variation_rotation_stocks_n2
    // sont gérés plus haut (vérification de seuil + disponibilité N-2)
    // -------------------------------------------------------------------------
 ...
 */
export function shouldIncludeRatio(ratioKey: string, donnees: ExtractionValues): boolean {
